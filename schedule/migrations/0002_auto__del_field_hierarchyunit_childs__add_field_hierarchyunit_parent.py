...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HierarchyUnit.childs'
        db.delete_column(u'schedule_hierarchyunit', 'childs_id')

        # Adding field 'HierarchyUnit.parent'
        db.add_column(u'schedule_hierarchyunit', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.HierarchyUnit'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HierarchyUnit.childs'
        db.add_column(u'schedule_hierarchyunit', 'childs',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.HierarchyUnit'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'HierarchyUnit.parent'
        db.delete_column(u'schedule_hierarchyunit', 'parent_id')
