...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.date_start'
        db.alter_column(u'schedule_event', 'date_start', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Event.date_end'
        db.alter_column(u'schedule_event', 'date_end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Event.date_start'
        db.alter_column(u'schedule_event', 'date_start', self.gf('django.db.models.fields.DateField')())
